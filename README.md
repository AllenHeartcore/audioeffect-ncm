...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                [1] Insert 3, Curve 0, Gain -2, Freq 200, Q 0.5<br>
                [2] Insert 3, Curve 1, Gain -1, Freq 2000, Q 0.5<br>
                [3] Insert 3, Curve 2, Gain 2, Freq 10000, Q 0.5
            </td>
        </tr>
        <tr>
            <td>Rock</td> <td>摇滚经典</td>
            <td></td> <td></td>
            <td>[-5.7, 0, 1.5, -3.81, -0.2, -1.1, 0.6, 1.5, 1.91, 1.91]</td>
        ...
        <tr>
            ...
            <td>
                [1] Insert 3, Curve 0, Gain -2, Freq 160, Q 1<br>
                [2] Insert 3, Curve 1, Gain -2.5, Freq 2000, Q 0.5<br>
                [3] Insert 3, Curve 2, Gain -3, Freq 8000, Q 0.5
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                [1] Insert 3, Curve 0, Gain -1, Freq 200, Q 1<br>
                [2] Insert 3, Curve 1, Gain -3, Freq 2000, Q 0.5<br>
                [3] Insert 3, Curve 2, Gain 0, Freq 8000, Q 0.5
            </td>
        ...
        <tr>
            ...
            <td>
                [1] Insert 3, Curve 0, Gain -1, Freq 200, Q 1<br>
                [2] Insert 3, Curve 1, Gain -3, Freq 2000, Q 0.5<br>
                [3] Insert 3, Curve 2, Gain -5, Freq 8000, Q 0.5
            </td>
        </tr>
        <tr>
            ...
            <td>
                [1] Insert 3, Curve 0, Gain -24, Freq 250, Q 0.5<br>
                [2] Insert 3, Curve 1, Gain 2, Freq 2000, Q 0.5<br>
                [3] Insert 3, Curve 2, Gain 1, Freq 12000, Q 0.5
            </td>
        </tr>
        <tr>
            ...
            <td>
                [1] Insert 3, Curve 0, Gain -2, Freq 80, Q 0.5<br>
                [2] Insert 3, Curve 1, Gain 0, Freq 1000, Q 1<br>
                [3] Insert 3, Curve 2, Gain -2, Freq 8000, Q 0.5
            </td>
        </tr>
        <tr>
